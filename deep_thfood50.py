...
Original file is located at
    https://colab.research.google.com/drive/1wa_uYFJ_xsX1P6jWfYBccGnUb3srXFcd
"""
...
def conv_bn_relu(num_filters, filter_size, stride, padding, name, layer_in):
  conv = Conv2D(num_filters, filter_size, stride, padding=padding, name=name)(layer_in)
...
def create_model():
  ...
  model.compile(
      optimizer= tf.keras.optimizers.SGD(learning_rate=lr, weight_decay=weight_decay)
